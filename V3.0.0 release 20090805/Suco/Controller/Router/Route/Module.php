...
class Suco_Controller_Router_Route_Module extends Suco_Controller_Router_Route_Abstract
{
	...
	{
		if (isset($options[Suco_Controller_Router_Route::ROUTE_SUFFIX])) {
			$this->_suffix = $options[Suco_Controller_Router_Route::ROUTE_SUFFIX];
		}
		if (isset($options[Suco_Controller_Router_Route::ROUTE_QUERY_DELIMIT])) {
			$this->_queryDelimit = $options[Suco_Controller_Router_Route::ROUTE_QUERY_DELIMIT];
		}
		if (isset($options[Suco_Controller_Router_Route::ROUTE_URL_DELIMIT])) {
			$this->_urlDelimit = $optinos[Suco_Controller_Router_Route::ROUTE_URL_DELIMIT];
		}
		
		$this->_dispatcher = Suco_Controller_Front::getInstance()->getDispatcher();
