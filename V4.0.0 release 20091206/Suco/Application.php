...
class Suco_Application
{
	...
	{
		if ($request instanceof Suco_Request_Interface) {
	...
	{
		if ($response instanceof Suco_Response_Interface) {
	...
	{
		if ($router instanceof Suco_Router_Interface) {
			$this->_router = $router;
		} else {
			require_once 'Suco/Router/Route.php';
			$this->_router = new Suco_Router_Route();
	...
	{
		if ($dispatcher instanceof Suco_Dispatcher_Interface) {
			$this->_dispatcher = $dispatcher;
		} else {
			require_once 'Suco/Dispatcher/Standard.php';
			$this->_dispatcher = new Suco_Dispatcher_Standard($this->getRequest(), $this->getResponse());
		}		
	}
