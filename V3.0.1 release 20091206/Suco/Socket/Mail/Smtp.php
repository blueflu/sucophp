...
class Suco_Socket_Mail_Smtp extends Suco_Socket_Abstract
{
	...
	public function send($to, $from, $subject, $body, $mailType = 'TXT', $cc = null, $bcc = null, $attch = null)
	{
		//邮件头
        ...
        foreach ($mailList as $mail) {
			$this->_send($from, $mail, iconv('utf-8', $this->_charset, $header), iconv('utf-8', $this->_charset, $body));
        }
	}
